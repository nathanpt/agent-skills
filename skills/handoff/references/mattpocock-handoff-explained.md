...
* [Skills](/skills)
  ...
  + - [5.1The /grill-me Skill](/skills-grill-me)
    - [5.2The /handoff Skill](/skills-handoff)
    - [5.3The /to-questionnaire Skill](/skills-to-questionnaire)
    - [5.4The /teach Skill](/skills-teach)
    - [5.5The /wait-what Skill](/skills-wait-what)
    - [5.6The /writing-for-agents Skill](/skills-writing-for-agents)
...
17 / 25AI Skills for Real Engineers
...
[Source Code](https://github.com/mattpocock/skills/tree/main/skills/productivity/handoff)[Next page](/skills-to-questionnaire)

Install this skill

$`npx skills@latest add mattpocock/skills --skill=handoff`

Then type`/handoff` in your coding agent.
...
`handoff` compacts the conversation you are in into a **handoff document** — one markdown file, written to your OS's temporary directory rather than into the workspace, that a fresh [agent](/ai-coding-dictionary/agent) can read to pick the work up.

What it buys is **portability**, not compression. That makes the skill narrower than it sounds. You need a file only when the work has to *travel* — to a new [harness](/ai-coding-dictionary/harness), a new directory, a colleague, or a side task you want to fork off. If nothing is travelling, you do not need a handoff: staying in the [session](/ai-coding-dictionary/session), `/clear`, a [subagent](/ai-coding-dictionary/subagent) and `/compact` cover the ordinary end-of-phase case, and `/compact` covers it more often than this skill does.
...
| --- | --- |
| Swapping harness — Claude → Codex | The new harness cannot see the old [context](/ai-coding-dictionary/context) |
...
For anything else — same harness, same directory, you are done [grilling](/ai-coding-dictionary/grilling) and moving to implementation — `/compact` is the move. [ask-matt](/skills-ask-matt) carries the ordered tree over all five options at a phase boundary.
...
Installs the whole set. Then type`/handoff` in your coding agent.

Update with npx skills update[Skills.sh](https://www.skills.sh/mattpocock/skills)

Share

[Share on X](https://x.com/intent/tweet?text=The%20%2Fhandoff%20Skill%20by%20%40mattpocockuk%0A%0Ahttps%3A%2F%2Fwww.aihero.dev%2Fskills-handoff "Share on X")[Share on Bluesky](https://bsky.app/intent/compose?text=The%20%2Fhandoff%20Skill%20by%20%40mattpocock.com%0A%0Ahttps%3A%2F%2Fwww.aihero.dev%2Fskills-handoff "Share on Bluesky")[Share on LinkedIn](https://linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.aihero.dev%2Fskills-handoff&title=The%20%2Fhandoff%20Skill "Share on LinkedIn")

## Related reading

* [Video9 Things People Get Wrong With /grill-me and /grill-with-docs](/things-people-get-wrong-with-grill-me-and-grill-with-docs)
* [Videogrill-with-docs: Align Before You Build](/grill-with-docs)
...
* + [5.1/grill-me](/skills-grill-me)
  + [5.2/handoff](/skills-handoff)
  + [5.3/to-questionnaire](/skills-to-questionnaire)
  + [5.4/teach](/skills-teach)
  + [5.5/wait-what](/skills-wait-what)
  + [5.6/writing-for-agents](/skills-writing-for-agents)