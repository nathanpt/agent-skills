...
renderer cannot import fs directly"] --> Rule["Add a direct fs import check"]
Rule --> Message["Tell the agent in the error message  
...
## Further Reading
- [How Google Tests Software - Whittaker et al.](https://books.google.dk/books/about/How\_Google\_Tests\_Software.html?id=VrAx1ATf-RoC&redir\_esc=y) — The classic source of the Testing Pyramid model
